...
@section('content')
    ...
    <a href="{{ $eventUrl }}" style="display:inline-block;background-color:#45a113;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;">View event</a>
@endsection